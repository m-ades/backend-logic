...
export default async function(
    ...
    rv.componentScores = options.question
        ? (options.highlightMainOperator ? [tableScore, mcScore, highlightScore] : [tableScore, mcScore])
        : (options.highlightMainOperator ? [tableScore, highlightScore] : [tableScore]);
