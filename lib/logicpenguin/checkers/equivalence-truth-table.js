...
export default async function(
    ...
    // table score: when partialcredit, use row-level credit; else all-or-nothing
    const tableScore = partialcredit && totalRows > 0
        ? (correctRowsA + correctRowsB) / (2 * totalRows)
        : (tableFullyCorrect ? 1 : 0);
